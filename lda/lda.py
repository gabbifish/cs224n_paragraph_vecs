...
id2word = gensim.corpora.Dictionary.load_from_text(bz2.BZ2File('big_wiki_results_wordids.txt.bz2'))
# load corpus iterator
mm = gensim.corpora.MmCorpus('big_wiki_results_tfidf.mm')
# mm = gensim.corpora.MmCorpus(bz2.BZ2File('wiki_subset_tfidf.mm.bz2')) # use this if you compressed the TFIDF output
print(mm)
id2word.save('big_wiki_subset_dict.dict')
